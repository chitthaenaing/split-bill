...
- "serviceCharge": SERVICE CHARGE / SERVICE / GRATUITY / TIP / AUTO-GRAT amount printed on the receipt (not a handwritten tip unless clearly written as part of the total). When the receipt prints "Service Charge (10%)" / "(5%)", use the printed baht/dollar AMOUNT, not the percent. Do NOT dump delivery / packaging / cover / bag fees here — those belong in additionalCharges with their printed labels.
