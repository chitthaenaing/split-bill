...
- "currency": ISO 4217 code (THB, EUR, GBP, JPY, SGD, AUD, MYR, IDR, INR, etc). Infer from symbols (\u00a3=GBP, \u20ac=EUR, \u00a5=JPY, \u0e3f=THB, RM=MYR, Rp=IDR, S$=SGD, A$=AUD). Bare amounts with NO currency symbol → THB. Do NOT emit USD — this app treats USD as unknown and maps it to THB (models invent USD when nothing is printed). Myanmar or Thai script → THB. Default to THB when nothing suggests another currency.
