...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full font-medium transition-all whitespace-nowrap " +
    ...
    "disabled:opacity-50 disabled:pointer-events-none select-none",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent text-accent-foreground hover:opacity-90 active:scale-[0.98] shadow-sm shadow-accent/20",
        secondary:
